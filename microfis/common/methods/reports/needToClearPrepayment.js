...
export const needToClearPrepaymentReport = new ValidatedMethod({
        ...
        run({params}) {
            if (!this.isSimulation) {
                ...
                selectorRepayment.isPrePay = true;

                data.header = header;

                //All Active Loan in check date

                selectorRepayment.dueDate = {$gte: fDate, $lte: tDate};
                ...
                let clearPrepay = RepaymentSchedule.aggregate([
                    ...
                    {
                        $match: {"repaymentDoc.type": "Prepay"}
                    }
                    ,
                    {
                        $lookup: {
                ...
                if (clearPrepay.length > 0) {
                    clearPrepay.forEach(function (clearPrepayDoc) {
                        ...
                        let finProductStatus = function (obj) {
                            return (clearPrepayDoc.repaymentDocRealTime.detail.numOfDayLate < 0 ? 0 : clearPrepayDoc.repaymentDocRealTime.detail.numOfDayLate ) >= obj.from && (clearPrepayDoc.repaymentDocRealTime.detail.numOfDayLate < 0 ? 0 : clearPrepayDoc.repaymentDocRealTime.detail.numOfDayLate ) <= obj.to;
                        }
                        ...
                        if (params.classifyId.includes(proStatus._id) == true || checkClassify == true) {
                            ...
                            principalPaid += clearPrepayDoc.repaymentDocRealTime.detail.principalPaid;
                            interestPaid += clearPrepayDoc.repaymentDocRealTime.detail.interestPaid;
                            feeOnPaymentPaid += clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                            penaltyPaid += clearPrepayDoc.repaymentDocRealTime.detail.penaltyPaid;


                            if (clearPrepayDoc.loanDoc.currencyId == "KHR") {

                                totalColPrinKHR += clearPrepayDoc.repaymentDocRealTime.detail.principalPaid;
                                totalColIntKHR += clearPrepayDoc.repaymentDocRealTime.detail.interestPaid;
                                totalColFeeOnPaymentKHR += clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                                totalColPrinIntKHR += clearPrepayDoc.repaymentDocRealTime.detail.principalPaid + clearPrepayDoc.repaymentDocRealTime.detail.interestPaid + clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                                totalColPenKHR += clearPrepayDoc.repaymentDocRealTime.detail.penaltyPaid;


                            } else if (clearPrepayDoc.loanDoc.currencyId == "USD") {
                                totalColPrinUSD += clearPrepayDoc.repaymentDocRealTime.detail.principalPaid;
                                totalColIntUSD += clearPrepayDoc.repaymentDocRealTime.detail.interestPaid;
                                totalColFeeOnPaymentUSD += clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                                totalColPrinIntUSD += clearPrepayDoc.repaymentDocRealTime.detail.principalPaid + clearPrepayDoc.repaymentDocRealTime.detail.interestPaid + clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                                totalColPenUSD += clearPrepayDoc.repaymentDocRealTime.detail.penaltyPaid;
                            } else if (clearPrepayDoc.loanDoc.currencyId == "THB") {
                                totalColPrinTHB = clearPrepayDoc.repaymentDocRealTime.detail.principalPaid;
                                totalColIntTHB = clearPrepayDoc.repaymentDocRealTime.detail.interestPaid;
                                totalColFeeOnPaymentTHB = clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                                totalColPrinIntTHB = clearPrepayDoc.repaymentDocRealTime.detail.principalPaid + clearPrepayDoc.repaymentDocRealTime.detail.interestPaid + clearPrepayDoc.repaymentDocRealTime.detail.feeOnPaymentPaid;
                                totalColPenTHB = clearPrepayDoc.repaymentDocRealTime.detail.penaltyPaid;
                            }
                            ...
                            content += `<tr>
                                ...
                                <td> ${microfis_formatDate(clearPrepayDoc.repaymentDocRealTime.detail.repaidDate)}</td>
                                <td> ${microfis_formatDate(clearPrepayDoc.dueDate)}</td>
