...
export const clientBalanceReport = new ValidatedMethod({
    ...
    run({params}) {
        if (!this.isSimulation) {
            ...
            selector['$or'] = [{status: "Active"},
                {closeDate: {$exists: true, $gte: date}},
                {writeOffDate: {$exists: true, $gte: date}},
                {restructureDate: {$exists: true, $gte: date}},
                {waivedDate: {$exists: true, $gte: date}}
            ];
                    ...
                    if (savingDoc && (savingDoc.details.interestBal + savingDoc.details.principalBal > 0)) {
                        if (savingDoc) {
                            ...
                            content += `<tr>
                                ...
                                <td> ${microfis_formatDate(savingDoc.transactionDate)}</td>

                                <td> ${loanAccDoc.creditOfficerDoc.khName}</td>

                    
                                <td class="numberAlign"> ${microfis_formatNumber(savingDoc.details.principalBal)}</td>
                                <td class="numberAlign"> ${microfis_formatNumber(savingDoc.details.interestBal)}</td>
                                
                                <td class="numberAlign"> ${microfis_formatNumber(savingDoc.details.interestBal + savingDoc.details.principalBal)}</td>
            ...
            content += `<tr>
                            ...
                            <td class="numberAlign">${microfis_formatNumber(totalDueIntKHR + totalDuePrinKHR)}</td>
                        ...
                        <tr>
                            ...
                            <td class="numberAlign">${microfis_formatNumber(totalDueIntUSD + totalDuePrinUSD)}</td>
                        ...
                        <tr>
                            ...
                            <td class="numberAlign">${microfis_formatNumber(totalDueIntTHB + totalDuePrinTHB)}</td>
                        ...
                        <tr>
                            ...
                            <td class="numberAlign">${microfis_formatNumber(totalDueIntBase + totalDuePrinBase)}</td>
