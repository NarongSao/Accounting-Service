...
export const writeOffReport = new ValidatedMethod({
            ...
            if (loanDoc.length > 0) {
                loanDoc.forEach(function (loanAccDoc) {
                    ...
                    content += `<tr>
                                ...
                                <td class="numberAlign"> ${microfis_formatNumber(loanAccDoc.writeOff.amount + loanAccDoc.writeOff.interest + loanAccDoc.writeOff.feeOnPayment)}</td>
