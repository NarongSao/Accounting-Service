...
// Method
import {clientBalanceReport} from '../../common/methods/reports/loan-clientBalance';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {ClientBalanceSchema} from '../../common/collections/reports/loan-clientBalance';

// Page
import './loan-clientBalance.html';

// Declare template
let indexTmpl = Template.Microfis_clientBalanceReport,
    tmplPrintData = Template.Microfis_clientBalanceReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_clientBalanceReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            clientBalanceReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        ...
        alertify.Microfis_clientBalanceReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_clientBalanceReport', hooksObject);
