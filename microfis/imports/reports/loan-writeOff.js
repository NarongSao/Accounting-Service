...
// Method
import {writeOffReport} from '../../common/methods/reports/loan-writeOff.js';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {WriteOffSchema} from '../../common/collections/reports/loan-writeOff.js';

// Page
import './loan-writeOff.html';

// Declare template
let indexTmpl = Template.Microfis_writeOffReport,
    tmplPrintData = Template.Microfis_writeOffReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_writeOffReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            writeOffReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        ...
        alertify.Microfis_writeOffReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_writeOffReport', hooksObject);
