...
// Method
import {waivedReport} from '../../common/methods/reports/loan-waived.js';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {WaivedSchema} from '../../common/collections/reports/loan-waived.js';

// Page
import './loan-waived.html';

// Declare template
let indexTmpl = Template.Microfis_waivedReport,
    tmplPrintData = Template.Microfis_waivedReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_waivedReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            waivedReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        ...
        alertify.Microfis_waivedReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_waivedReport', hooksObject);
