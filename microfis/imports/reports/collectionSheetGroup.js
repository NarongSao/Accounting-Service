...
// Method
import {collectionSheetGroupReport} from '../../common/methods/reports/collectionSheetGroup';
import {GenerateFile} from '../libs/saveExcelFIle';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {CollectionSheetGroupSchema} from '../../common/collections/reports/collectionSheetGroup';

// Page
import './collectionSheetGroup.html';

// Declare template
let indexTmpl = Template.Microfis_collectionSheetGroupReport,
    tmplPrintData = Template.Microfis_collectionSheetGroupReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            collectionSheetGroupReport.callPromise({params: params})
                .then((result) => {
    ...
    createNewAlertify('Microfis_collectionSheetGroupReport');
...
indexTmpl.helpers({
    schema(){
        return CollectionSheetGroupSchema;
    },
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        ...
        alertify.Microfis_collectionSheetGroupReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_collectionSheetGroupReport', hooksObject);
