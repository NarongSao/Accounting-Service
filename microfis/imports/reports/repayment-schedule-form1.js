...
// Method
import {repaymentScheduleForm1Report} from '../../common/methods/reports/repayment-schedule-form1';

// Schema
import {RepaymentScheduleSchema} from '../../common/collections/reports/repayment-schedule.js';

// Page
import './repayment-schedule-form1.html';

// Declare template
let indexTmpl = Template.Microfis_repaymentScheduleForm1Report,
    tmplPrintData = Template.Microfis_repaymentScheduleForm1ReportPrintData;
...
indexTmpl.onCreated(function () {
    ...
    createNewAlertify('Microfis_repaymentScheduleForm1Report');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            repaymentScheduleForm1Report.callPromise(params)
                .then((result) => {
...
indexTmpl.events({
    ...
    'click .fullScreen'(event, instance){
        alertify.Microfis_repaymentScheduleForm1Report(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_repaymentScheduleForm1Report', hooksObject);
