...
// Method
import {productActivityReport} from '../../common/methods/reports/productActivity.js';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {ProductActivitySchema} from '../../common/collections/reports/productActivity.js';

// Page
import './productActivity.html';

// Declare template
let indexTmpl = Template.Microfis_productActivityReport,
    tmplPrintData = Template.Microfis_productActivityReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_productActivityReport');
    this.autorun(() => {
        // Check form data
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_productActivityReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_productActivityReport', hooksObject);
