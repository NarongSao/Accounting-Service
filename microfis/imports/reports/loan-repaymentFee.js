...
// Method
import {loanRepaymentFeeReport} from '../../common/methods/reports/loan-repaymentFee';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {LoanRepaymentFeeSchema} from '../../common/collections/reports/loan-repaymentFee';

// Page
import './loan-repaymentFee.html';

// Declare template
let indexTmpl = Template.Microfis_repaymentFeeReport,
    tmplPrintData = Template.Microfis_repaymentFeeReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_repaymentFeeReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            loanRepaymentFeeReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_repaymentFeeReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_repaymentFeeReport', hooksObject);
