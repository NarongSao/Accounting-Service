...
// Method
import {purchaseReport} from '../../common/methods/reports/purchase.js';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {PurchaseSchema} from '../../common/collections/reports/purchase.js';

// Page
import './purchase.html';

// Declare template
let indexTmpl = Template.Microfis_purchaseReport,
    tmplPrintData = Template.Microfis_purchaseReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_purchaseReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            purchaseReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        ...
        alertify.Microfis_purchaseReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_purchaseReport', hooksObject);
