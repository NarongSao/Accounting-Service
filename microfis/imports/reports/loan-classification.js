...
// Method
import {loanClassificationReport} from '../../common/methods/reports/loan-classification';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {LoanClassificationSchema} from '../../common/collections/reports/loan-classification';

// Page
import './loan-classification.html';

// Declare template
let indexTmpl = Template.Microfis_loanClassificationReport,
    tmplPrintData = Template.Microfis_loanClassificationReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_loanClassificationReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            loanClassificationReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.helpers({
    schema(){
        return LoanClassificationSchema;
    },
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_loanClassificationReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_loanClassificationReport', hooksObject);
