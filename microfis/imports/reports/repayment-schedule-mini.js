...
// Page
import './repayment-schedule-mini.html';

// Declare template
let indexTmpl = Template.Microfis_repaymentScheduleMiniReport,
    tmplPrintData = Template.Microfis_repaymentScheduleMiniReportPrintData;
...
indexTmpl.onCreated(function () {
    ...
    createNewAlertify('Microfis_repaymentScheduleMiniReport');
    this.autorun(() => {
        // Check form data
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_repaymentScheduleMiniReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_repaymentScheduleMiniReport', hooksObject);
