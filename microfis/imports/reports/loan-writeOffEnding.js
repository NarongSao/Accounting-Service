...
// Method
import {writeOffEndingReport} from '../../common/methods/reports/loan-writeOffEnding';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {WriteOffEndingSchema} from '../../common/collections/reports/loan-writeOffEnding';

// Page
import './loan-writeOffEnding.html';

// Declare template
let indexTmpl = Template.Microfis_writeOffEndingReport,
    tmplPrintData = Template.Microfis_writeOffEndingReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_writeOffEndingReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            writeOffEndingReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        ...
        alertify.Microfis_writeOffEndingReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_writeOffEndingReport', hooksObject);
