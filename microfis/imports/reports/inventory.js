...
// Method
import {inventoryReport} from '../../common/methods/reports/inventory.js';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {InventorySchema} from '../../common/collections/reports/inventory.js';

// Page
import './inventory.html';

// Declare template
let indexTmpl = Template.Microfis_inventoryReport,
    tmplPrintData = Template.Microfis_inventoryReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_inventoryReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            inventoryReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_inventoryReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_inventoryReport', hooksObject);
