...
// Method
import {contractReport} from '../../common/methods/reports/contract';

// Schema
import {ContractSchema} from '../../common/collections/reports/contract';

// Page
import './contract.html';

// Declare template
let indexTmpl = Template.Microfis_contractReport,
    tmplPrintData = Template.Microfis_contractReportPrintData;
...
indexTmpl.onCreated(function () {
    ...
    createNewAlertify('Microfis_contractReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            contractReport.callPromise(params)
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_contractReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_contractReport', hooksObject);
