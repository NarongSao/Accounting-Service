...
// Method
import {loanArrearsReport} from '../../common/methods/reports/loan-arrears';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {LoanArrearsSchema} from '../../common/collections/reports/loan-arrears';

// Page
import './loan-arrears.html';

// Declare template
let indexTmpl = Template.Microfis_loanArrearsReport,
    tmplPrintData = Template.Microfis_loanArrearsReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_loanArrearsReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            loanArrearsReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_loanArrearsReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_loanArrearsReport', hooksObject);
