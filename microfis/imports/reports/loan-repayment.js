...
// Method
import {loanRepaymentReport} from '../../common/methods/reports/loan-repayment';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {LoanRepaymentSchema} from '../../common/collections/reports/loan-repayment';

// Page
import './loan-repayment.html';

// Declare template
let indexTmpl = Template.Microfis_loanRepaymentReport,
    tmplPrintData = Template.Microfis_loanRepaymentReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_loanRepaymentReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            loanRepaymentReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_loanRepaymentReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_loanRepaymentReport', hooksObject);
