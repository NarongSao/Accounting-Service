...
// Method
import {loanBreakDownByCurrencyReport} from '../../common/methods/reports/loan-breakDownByCurrency';
import {SelectOptMethods} from '../../common/methods/select-opts.js';

// Schema
import {LoanBreakDownByCurrencySchema} from '../../common/collections/reports/loan-breakDownByCurrency';

// Page
import './loan-breakDownByCurrency.html';

// Declare template
let indexTmpl = Template.Microfis_loanBreakDownByCurrencyReport,
    tmplPrintData = Template.Microfis_loanBreakDownByCurrencyReportPrintData;
// Form state
...
indexTmpl.onCreated(function () {
    createNewAlertify('Microfis_loanBreakDownByCurrencyReport');
    this.autorun(() => {
        // Check form data
        if (formDataState.get()) {
            ...
            loanBreakDownByCurrencyReport.callPromise({params: params})
                .then((result) => {
...
indexTmpl.helpers({
    schema(){
        return LoanBreakDownByCurrencySchema;
    },
...
indexTmpl.events({
    'click .fullScreen'(event, instance){
        alertify.Microfis_loanBreakDownByCurrencyReport(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
...
AutoForm.addHooks('Microfis_loanBreakDownByCurrencyReport', hooksObject);
