    ...
    acc_BalanceSheetNBCKH: function (params) {
        if (!this.isSimulation) {
            ...
            if (math.abs(compare) < 0.05) {
                ...
                data.premiumOnShareCapitalTotal = data.premiumOnShareCapitalTotal + compare;
                data.premiumOnShareCapitalOther = data.premiumOnShareCapitalOther + compare;

                data.shareHolderTotal = data.shareHolderTotal + compare;
                data.shareHolderOther = data.shareHolderOther + compare;

                data.paidUpCapitalOther = data.paidUpCapitalOther + compare;
                data.paidUpCapitalTotal = data.paidUpCapitalTotal + compare;
            }
            return data;
        }
    }
