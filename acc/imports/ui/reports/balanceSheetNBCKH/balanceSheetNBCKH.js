...
var reportTpl = Template.acc_BalanceSheetNbcKhReport,
    ...
    tmplPrintData = Template.acc_BalanceSheetNbcKhPrintReportGen;
...
reportTpl.onCreated(function () {
    createNewAlertify('acc_BalanceSheetNBCKH');
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            Meteor.call('acc_BalanceSheetNBCKH', params, function (err, result) {
                if (result) {
...
reportTpl.events({
    ...
    'click .fullScreen'(event, instance){
        ...
        alertify.acc_BalanceSheetNBCKH(fa('', ''), renderTemplate(tmplPrintData)).maximize();
    },
